...
#DESCOMENTAR PARA ENTRENAR DE NUEVO
#trained_c45_h1n1_vaccine = train(h1n1_vaccine ~ ., data=x_train,
#                                 method="J48", metric="Accuracy",trControl=fitControl,
#                                 tuneGrid=rfGrid)
trained_c45_h1n1_vaccine = readRDS("trained/c45_h1n1_vaccine.rds")

#Los mejores parámetros encontrados han sido C=0.1 y M=40 con una accuracy en
#training de 0.8267123.
...
#                                 method="J48", metric="Accuracy",trControl=fitControl,
#                                 tuneGrid=rfGrid)
trained_c45_seasonal_vaccine = readRDS("trained/c45_seasonal_vaccine.rds")

#Los mejores parámetros encontrados han sido C=0.1 y M=20 con una accuracy en
#training de 0.7671395.
