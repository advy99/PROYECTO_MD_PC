...
#Los mejores parámetros encontrados han sido C=0.15 y M=40.
...
#Los mejores parámetros encontrados han sido C=0.025 y M=25.
...
#Los mejores parámetros encontrados han sido C=0.2 y M=80.
